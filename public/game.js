//Initialize ScavengerHunt function on startup, get client num
window.onload = function() {
  window.ScavengerHunt = new ScavengerHunt();
};

var client = getParameterByName('client');
var clientfield = document.getElementById('clientNum');
...
ScavengerHunt.prototype.captureImage = function() {
  ...
  if (this.checkSignedInWithMessage()) {
    ...
    var clientfield = document.getElementById('clientNum').value;
    var imageLink = "images/" + clientfield + ".jpg";
  	...
  	imageRef.putString(imagelink, 'data_url').then(function(snapshot) {
